...
declare const messages: {
  ...
  "compound_interest": {
    ...
    "intro": {
      ...
      "einstein_quote": "\"Ränta-på-ränta är världens åttonde underverk. Den som förstår den, tjänar på den; den som inte gör det, betalar för den.\" - Ofta tillskrivet Albert Einstein",
