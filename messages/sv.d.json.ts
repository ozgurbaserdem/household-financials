...
declare const messages: {
  ...
  landing: {
    ...
    previews: {
      ...
      budget_results_description: "Omfattande ekonomisk analys med poängsystem (0-100) för finansiell hälsa, jämförelse av 9 lånescenarier med olika räntor/amorteringar, visuell utgiftsfördelning med procentsatser och månadsbudget. Visa återstående kapital efter utgifter och personliga rekommendationer baserat på din ekonomiska situation.";
      ...
      compound_interest_description: "Sofistikerad kalkylator med avancerade inställningar för årlig sparökning (0-50%), planerade uttag (procent eller fast belopp), och interaktiva prognoser upp till 50 år. Visar detaljerade diagram över tillväxt, jämför olika avkastningsnivåer och beräknar optimal timing för uttag. Perfekt för pensionsplanering och långsiktig förmögenhetsbyggande.";
      ...
      budget_wizard_description: "Intuitiv 5-stegs process som guidar dig genom inkomstregistrering med automatisk kommunalskatt, låneparametrar med ränta/amortering, och detaljerad utgiftsanalys i 13 kategorier från boende till fritid. Inkluderar intelligent kommunsökning och anpassningsbara skatteinställningar för exakt beräkning.";
      ...
      go_to_slide: "Gå till bild {number}: {title}";
      fullsize_alt: "Fullstorleksvisning av {title}";
      navigation_previous: "Föregående förhandsgranskning";
      navigation_next: "Nästa förhandsgranskning";
    };
  };
  compound_interest: {
