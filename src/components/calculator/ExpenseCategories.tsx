    ...
    >
      {isMobile && (
        <button
          ...
          className={
            "w-full flex items-center justify-between transition-colors hover:bg-gray-50 dark:hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-gray-950 rounded-lg p-4"
          }
          aria-expanded={isExpanded}
          aria-controls="expense-categories-content"
        >
          <div className="flex items-center gap-3">
            ...
            <span
              tabIndex={0}
              aria-label={t("aria.title")}
              className="font-semibold text-2xl font-bold text-gray-900 dark:text-gray-100"
            >
              {isExpanded ? t("hide_expenses") : t("add_expenses")}
            </span>
          </div>
          {isExpanded ? (
