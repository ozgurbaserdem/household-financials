...
1000000,3.5|4,2|3,30000,25000,20000,15000,5000,1000,3000,2000`;
    ...
    expect(importedState.income1).toBe(30000);
    expect(importedState.income2).toBe(25000);
    expect(importedState.secondaryIncome1).toBe(20000);
    expect(importedState.secondaryIncome2).toBe(15000);
